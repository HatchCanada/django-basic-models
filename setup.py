...
exec(compile(open(os.path.join(os.path.dirname(__file__), 'basic_models/version.py')).read(), os.path.join(os.path.dirname(__file__), 'basic_models/version.py'), 'exec'))
